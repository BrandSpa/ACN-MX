	...
	class VC_Templates_Import_Export {
		...
		public function export_tab() {
			...
			if ( $saved_templates ) {
				...
				$output .= '<thead>';
				$output .= '<tr>';
				$output .= '<td class="manage-column check-column"><input id="cb-select-all-1" type="checkbox"></td><th scope="col" id="title" class="manage-column column-title"><strong><label for="cb-select-all-1">Template Name</label></strong></th>';
				$output .= '</tr>';
				$output .= '</thead>';
				$output .= '<tbody>';
				foreach ( $saved_templates as $key => $template ) {
					$output .= '<tr>';
					$output .= '<th class="check-column"><input id="' . $key . '" type="checkbox" name="templates[]" value="' . $key . '"></th>';
				...
				$output .= '<tfoot>';
				$output .= '<tr>';
				$output .= '<td class="manage-column check-column"><input id="cb-select-all-1" type="checkbox"></td><th scope="col" id="title" class="manage-column column-title"><strong><label for="cb-select-all-1">Select All</label></strong></th>';
				$output .= '</tr>';
				$output .= '</tfoot>';
				$output .= '</table>';
